...
//alid Perfect Squar(nput & Ouput)

//et a positive integer. Check the number whether perfect square or not. Print TRUE when the integer is perfect square.If it is not, return FALSE.
